...
Memory Reduction in Efficient version for large and small datasets is approximately 83.425%. Using weigted average.
SUMPRODUCT(Percentage Reduction in Space * (M+N)) / SUM(M+N)
